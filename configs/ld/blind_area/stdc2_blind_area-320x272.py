# ===== Global Constants =====
CLASS_NAMES = ("background", "blind_area")  # 背景，盲区
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='.',
        ann_file='configs/ld/blind_area/val.txt',
        class_names=CLASS_NAMES,
...
log_level = 'INFO'
load_from = "work_dirs/ld/grass/stdc2_grass-c4-320x272-penalty_fp_bg_0702/epoch_70.pth"
resume = False
