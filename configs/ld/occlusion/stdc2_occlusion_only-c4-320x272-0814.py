# ===== Global Constants =====
CLASS_NAMES = ("background", "occlusion", "glare", "pure_background")
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/mck/datasets/occlusion_only',
...
log_level = 'INFO'
load_from = "work_dirs/ld/occlusion/stdc2_occlusion_only-c4-320x272-0806/last_checkpoint"
resume = False
