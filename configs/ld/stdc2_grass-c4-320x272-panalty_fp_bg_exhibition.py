...
model = dict(
    ...
    decode_head=dict(
        ...
        sampler=dict(type='OHEMPixelSamplerWithSpecialClassPanalty', gt_class=-1, panalty_pred_class=0, thresh=0.7, min_kept=10000)
    ),
    auxiliary_head=[
        dict(
            type='FCNHead',
...
TEST_FOLDERS = ['songshanhu_factory', '20250622_exhibition']
REPEAT_FOLDERS = {'songshanhu_factory': 2, '20250622_exhibition': 2}
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/mck/datasets/exhibition',
        num_classes=NUM_CLASSES,
