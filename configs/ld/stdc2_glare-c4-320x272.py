...
GLARE_FOLDERS = ['glare_seg', 'glare_seg2']
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=False,
        include=GLARE_FOLDERS,
        metainfo={'classes': ['background', 'background', 'soil', 'background']} # soil其实是glare 将glare以外的都归为background
    )
)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=True,
        include=GLARE_FOLDERS,
        metainfo={'classes': ['background', 'background', 'soil', 'background']}
    )
)
