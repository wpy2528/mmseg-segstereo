# ===== Global Constants =====
RESIZE_WH = (1280 // 2, 720 // 2)
BATCH_PAD_HW = RESIZE_WH[::-1]
...
model = dict(
    ...
    decode_head=dict(
        ...
        sampler=dict(type='PixelRangeSampler', min_value=0.0, max_value=5000.0)
    ),
    auxiliary_head=None,
    train_cfg=dict(),
...
dataset_type = 'LDPerceptionMonocularDepthDataset'

train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', to_uint8=False),
    dict(
        type='Resize',
        scale=RESIZE_WH,
        keep_ratio=False,
