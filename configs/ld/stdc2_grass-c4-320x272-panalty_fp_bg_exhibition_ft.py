...
model = dict(
    ...
    decode_head=dict(
        ...
        sampler=dict(type='OHEMPixelSamplerWithSpecialClassPenalty', gt_class=-1, penalty_pred_class=0, thresh=0.7, min_kept=10000)
    ),
    auxiliary_head=[
        dict(
            type='FCNHead',
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/mck/datasets/exhibition_only',
        num_classes=NUM_CLASSES,
