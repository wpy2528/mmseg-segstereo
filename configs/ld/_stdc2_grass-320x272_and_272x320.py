...
train_dataloader = dict(
    ...
    batch_sampler=dict(type='FrontAndSideImageBatchSampler', drop_last=True),
    dataset=dict(
        type=dataset_type,
        data_root='/home/mck/datasets/grass_seg_data_c3_272x320/train/',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/home/mck/datasets/grass_seg_data_c3_272x320/val/',
