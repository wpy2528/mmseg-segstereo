...
def main():
    ...
    for index in indexes:
        ...
        if args.create_augmented_dataset:
            ...
            src_image_np = img
            gt_np = data_sample.gt_sem_seg.data[0]
            gt_np = gt_np.astype(np.float32)
            vis_max = 5000
            gt_np = np.clip(gt_np, 0, vis_max)
            ...
            gt_color_np[(gt_norm == 0) | (gt_norm == 255)] = 255
            
            vis_np = np.concatenate([src_image_np, gt_color_np], axis=1)
